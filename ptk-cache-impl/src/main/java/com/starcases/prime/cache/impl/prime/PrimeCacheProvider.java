 ...
 *
 */
public class PrimeCacheProvider implements CacheProviderIntfc<Long,Long>
{
	/**
	 ...
	 */
	@Override
	public PersistedCacheIntfc<Long,Long> create( @NonNull final Path cache, final boolean clearCache)
	{
		final var cacheImpl = new PrimeSubsetCacheImpl(cache.getFileName().toString(), cache.getParent(), clearCache);
	...
	@Override
	public PersistedCacheIntfc<Long, Long> getCache(String cacheName)
	{
