...
public interface PrimeBaseGenerateIntfc
{
	 ...
	 * @param doLog
	 */
	void setBaseGenerationOutput(final boolean doLog);

	PrimeBaseGenerateIntfc doPreferParallel(final boolean doPrefParallel);
	void setTrackTime(final boolean doTrackTime);
}
